const _=`include <gridfinity-rebuilt-utility.scad>
...
`,i=`include <gridfinity-rebuilt-utility.scad>
...
`,o=`include <gridfinity-rebuilt-utility.scad>
...
`,c=Object.assign({"./rugged_box/gridfinity-rebuilt-openscad/gridfinity-rebuilt-baseplate.scad":_,"./rugged_box/gridfinity-rebuilt-openscad/gridfinity-rebuilt-bins.scad":i,"./rugged_box/gridfinity-rebuilt-openscad/gridfinity-rebuilt-lite.scad":a,"./rugged_box/gridfinity-rebuilt-openscad/gridfinity-rebuilt-utility.scad":l,"./rugged_box/gridfinity-rebuilt-openscad/gridfinity-spiral-vase.scad":o,"./rugged_box/gridfinity-rebuilt-openscad/standard.scad":s,"./rugged_box/rugged-box-gridfinity.scad":d,"./rugged_box/rugged-box-library.scad":h}),b={},e="./rugged_box/";for(const[n,t]of Object.entries(c)){const r=n.slice(n.indexOf(e)+e.length);b["/rb/"+r]=t}export{b as default};
